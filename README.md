# Henna Parmar's Portfolio

## Welcome!
Hi, I'm Henna! This portfolio showcases my programming and data science projects across multiple languages and domains. I'm passionate about leveraging technology to solve complex problems through data science, machine learning, and software engineering.

🌐 **Portfolio Website:** [https://hparmar3.github.io](https://hparmar3.github.io)

## About Me
I'm a data science and software engineering enthusiast with experience in machine learning, mathematical optimization, and full-stack development. My projects demonstrate proficiency in:
- Mathematical optimization with `MATLAB` and `Python`
- Machine learning and data analysis with `Python`, `R`, and `NumPy/Pandas`
...
A hands-on implementation of Logistic Regression and K-Means Clustering algorithms coded entirely from scratch using NumPy. Demonstrates gradient descent optimization, decision boundary visualization, and cluster assignments without using Scikit-learn or other ML libraries.
...
Comprehensive data visualization and linear regression analysis pipeline for predicting diabetes progression. Includes feature inspection, correlation heatmap analysis, and model evaluation using MSE and R² metrics.
...
Standard Simplex Method implementation for solving linear programming problems in MATLAB. Uses Bland's Rule for pivot selection to prevent cycling and provides verbose output at each iteration.
- **Technologies:** MATLAB
- **Key Features:** Standard form LP solver, Bland's Rule implementation, unbounded problem detection

#### [Big M Method](Big%20M%20Method/)
MATLAB implementation of the Big M Method for solving linear programming problems involving equality constraints and artificial variables. Automatically handles infeasibility with penalty terms.
- **Technologies:** MATLAB
- **Key Features:** Artificial variable handling, automatic M calculation, negative RHS correction
...
- **Technologies:** MATLAB
- **Key Features:** Modular design, Bland's Rule, phase-by-phase tableau visualization
...
#### [Steepest Descent Method](Steepest%20Decent%20Method/)
...
- **Technologies:** MATLAB
- **Key Features:** Gradient-based optimization, symmetric positive definite matrices, convergence analysis
...
#### [Markov Chain Analysis](Markov%20Chain/)
Markov Chain implementation for stochastic process modeling and analysis. Includes applications in text generation using probabilistic word sequences from classic literature via Project Gutenberg.
- **Technologies:** Python, Jupyter Notebook
- **Key Features:** State transition modeling, probability chain construction, text generation

#### [Moving Average Trading Strategy](Moving%20Average/)
...
#### [Text Generator](Text%20Generator/)
...
- **Key Features:** Responsive design, semantic markup, navigation system, code snippets

#### [Guide Effort Tool Website](Guide%20Effort%20Tool%20Website/)
Interactive Shiny Flexdashboard application for importing, processing, and visualizing clinical guide participation data across multiple studies. Includes REDCap API integration and dynamic filtering.
...
**Programming Languages:** Python, MATLAB, R, Java, JavaScript  
**Data Science & ML:** Machine Learning, Data Visualization, NumPy, Pandas, Scikit-learn  
**Optimization:** Linear Programming, Simplex Methods, Numerical Optimization  
...
- **LinkedIn:** [linkedin.com/in/hennaparmar3](https://www.linkedin.com/in/hennaparmar3/)
- **GitHub:** [github.com/hparmar3](https://github.com/hparmar3)

## Notes
- Each project folder contains a detailed `README` with setup instructions, usage guidelines, and technical explanations
- Projects may require specific environments or dependencies, which are documented in their respective `README` files
- Visit the [portfolio website](https://hparmar3.github.io) for an organized, visual presentation of all projects
